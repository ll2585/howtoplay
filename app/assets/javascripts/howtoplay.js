var howToPlayApp = angular.module('howToPlayApp', ['SplendorCtrl', 'ngJoyRide', 'templates'], function($interpolateProvider) {
...
howToPlayApp.controller('MainCtrl', function($scope){
    ...
    $scope.loadGame = function(name){
        ...
        $scope.selectedGameURL = $scope.selectedGame + ".html";
    }
